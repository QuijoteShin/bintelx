<?php
# bintelx/kernel/Entity/Customer.php
namespace bX\Entity;
...
class Customer
{
    ...
    /**
     * Crea un cliente y su relación con el scope actual
     *
     * @param array $data [
    ...
    public static function create(
        ...
        if ($existing) {
            return [
                'success' => false,
                'message' => 'Customer already exists in this scope',
        ...
        try {
            ...
            # Buscar sombras (otros scopes con mismo cliente)
    ...
    /**
     * Busca cliente por identity_hash en el scope actual
     *
    ...
    /**
     * Lista clientes del scope actual
     *
